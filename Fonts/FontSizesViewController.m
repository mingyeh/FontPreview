...
-(NSArray *)pointSizes{
    ...
    dispatch_once(&token,^{
        pointSizes = @[@9,@10,@11,@12,@13,@14,@18,@24,@26,@48,@64,@72,@96,@144];
    });
...
-(UIFont *)fontForDisplayAtIndexPath:(NSIndexPath *)indexPath{
    NSNumber *pointSize = [[self pointSizes] objectAtIndex:indexPath.row];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.detailTextLabel.text = [NSString stringWithFormat:@"%@ points",[self pointSizes][indexPath.row]];
